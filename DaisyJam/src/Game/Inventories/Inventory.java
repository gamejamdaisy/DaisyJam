...
public class Inventory {
    ...
    private void renderItems(Graphics g) {
        ...
        if (inventoryItems.size() == 1) {
            ...
            g.drawImage(inventoryItems.get(9).getTexture(), 269, 85, inventoryItems.get(9).getWidth(), inventoryItems.get(8).getHeight(), null);
            g.drawString(String.valueOf(inventoryItems.get(9).getCount()), 269+33,85+35);
